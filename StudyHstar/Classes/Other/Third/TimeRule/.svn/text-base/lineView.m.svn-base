...
- (void)makeTimeMiddleLabel
{
    ...
    lable.backgroundColor = kdefaulColor;
...
- (void)drawRect:(CGRect)rect
{
    ...
    // 设置线的颜色
    CGContextSetStrokeColorWithColor(context, kdefaulColor.CGColor);
    ...
    [@"00:00" drawAtPoint:CGPointMake(ktimelocation, start_y+10) withAttributes:@{NSForegroundColorAttributeName:kdefaulColor,NSFontAttributeName:[UIFont systemFontOfSize:kFontSize]}];
    // 绘制刻度
    ...
    for (int i=1; i<=ktimeCount; i++) {
        ...
        if ((i%3 == 0)&&(i%6 != 0)) {
            ...
            [timeText drawAtPoint:CGPointMake((i*ktimeGap) +ktimelocation, start_y+10) withAttributes:@{NSForegroundColorAttributeName:kdefaulColor,NSFontAttributeName:[UIFont systemFontOfSize:kFontSize]}];
